...
# ================= MAIN BOT =================
print("🚀 HeroStake AI Bot Started | 1.9x Recovery + Anti-Bot v2")
...
while True:
    try:
        ...
        if loss_streak == 0:
            ...
            current_bet = int(needed_to_recover / 0.9)   # 1.9x = 90% profit
        ...
        for username, balance, base_bet, take_profit, stop_loss, current_profit in active_users:
            ...
            new_capital = balance + int(user_bet * 0.9) if is_win else balance - user_bet
